...
namespace Docu.Documentation
{
    public class DeclaredType : BaseDocumentationElement, IReferencable
    {
        ...
        readonly List<Enumeration> enums = new List<Enumeration>();
        ...
        public IList<Enumeration> Enums
        {
            get { return enums; }
        }
        ...
        public bool IsEnum
        {
            get { return declaration != null && declaration.IsEnum; }
        }
        public bool IsClass
        {
            get { return declaration != null && declaration.IsClass; }
        }
