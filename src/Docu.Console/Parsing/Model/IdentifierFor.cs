...
namespace Docu.Parsing.Model
{
    public static class IdentifierFor
    {
        ...
        public static PropertyIdentifier Property(PropertyInfo property, Type type, bool isStatic)
        {
            return new PropertyIdentifier(property.Name, property.CanRead, property.CanWrite, isStatic, Type(type));
        }
        ...
        public static EnumIdentifier Enum(MemberInfo field, Type type)
        {
            return new EnumIdentifier(field.Name, Type(type));
        }
        ...
        public static Identifier XmlString(string name)
        {
            ...
            if (prefix == 'P') return new PropertyIdentifier(GetMethodName(trimmedName), false, false, false, TypeString(GetTypeName(trimmedName)));
